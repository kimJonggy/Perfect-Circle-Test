...
const SparkleButton = ({ onClick, className, children, ...props }: SparkleButtonProps) => {
    return (
        <StyledWrapper>
            <div className="sp">
                <button className={`sparkle-button ${className || ''}`} onClick={onClick} {...props}>
                    ...
                    <span className="text">{children || 'Connect Wallet'}</span>
                </button>
                ...
                <span aria-hidden="true" className="particle-pen">
                    ...
                    {/* Repeated particles as per user request (condensed here for brevity if same path but user gave many) */}
                    {/* The user gave many identical particles. I will include 6-8 of them to match the visual density */}
                    {[...Array(8)].map((_, i) => (
